...
2: Update the code to use the stages from the file hangman_art.py
...
6: Update the code below to tell the user how many lives they have left. print("****************************<???>/6 LIVES LEFT****************************")

7: Update the print statement to give the user the correct word they were trying to guess.
